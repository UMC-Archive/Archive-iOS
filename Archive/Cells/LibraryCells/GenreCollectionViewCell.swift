...
class GenreCollectionViewCell: UICollectionViewCell {
    ...
    private enum constant {
        static let genreImageCollectionViewSize = UIScreen.main.isWiderThan375pt ? CGSize(width: 50, height: 50) : CGSize(width: 50, height: 50)
    ...
    private let genreImage = UIImageView() //collectionView로 변경 예정
    ...
    private func setComponent(){
        ...
        genreImage.snp.makeConstraints{
            ...
            $0.size.equalTo(constant.genreImageCollectionViewSize)
        }
